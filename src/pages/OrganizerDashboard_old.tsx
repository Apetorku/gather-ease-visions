...
import { Badge }       <div className="container mx-auto px-4 py-12">
        {/* Welcome Section */}
        <motion.div
        ...
        >
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-sm sm:text-base text-muted-foreground">Manage your events, team, and organization</p>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
            <GlassCard className="p-4 text-center">
              <div className="text-2xl font-bold text-primary">{organizationStats.totalEvents}</div>
              <div className="text-sm text-muted-foreground">Total Events</div>
            </GlassCard>
            <GlassCard className="p-4 text-center">
              <div className="text-2xl font-bold text-green-500">${organizationStats.totalRevenue.toLocaleString()}</div>
              <div className="text-sm text-muted-foreground">Revenue</div>
            </GlassCard>
            <GlassCard className="p-4 text-center">
              <div className="text-2xl font-bold text-blue-500">{organizationStats.totalAttendees}</div>
              <div className="text-sm text-muted-foreground">Attendees</div>
            </GlassCard>
            <GlassCard className="p-4 text-center">
              <div className="text-2xl font-bold text-yellow-500">{organizationStats.avgRating}</div>
              <div className="text-sm text-muted-foreground">Avg Rating</div>
            </GlassCard>
            <GlassCard className="p-4 text-center">
              <div className="flex items-center justify-center gap-1">
                <TrendingUp className="w-5 h-5 text-green-500" />
                <div className="text-xl font-bold text-green-500">+{organizationStats.growthRate}%</div>
              </div>
...
import { Calendar, Users, BarChart3, Ticket, Plus, Settings, Edit, Trash2, UserPlus, Shield, Clock, TrendingUp, Download } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
